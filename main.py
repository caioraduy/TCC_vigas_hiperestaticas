...
if __name__== '__main__':
    ...
    #viga = Vigahiperestatica(lista_comprimentos=[10,10,10],lista_cargas_q=[10,10,10]
                             #, b= 0.2, h=0.3, fck = 30)

    viga = Vigahiperestatica(lista_comprimentos=[10, 10, 10,10], lista_cargas_q=[10, 10, 10,10], balanco_esquerdo=True,
